...
# from transformers import pipeline # used in the summerization
...
st.sidebar.write("HuggingFace API token")
...
API_KEY = st.sidebar.text_input(
    ...
    type="password",
    value="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",
...
with st.form(key="my_form"):
        ...
        labels_from_st_tags = st_tags(
            value=["Arts", "Brain-based Learning","Bully Prevention","Collaborative learning", "Computer Science Coding", "Critical Thinking",
            # "Cirriculoum Planning", "Design Thinking", "Differentiated Instruction", "Diversity", "Education Equity","Eligibility","English Language Arts", 
            # "Entrepreneurship", "Environmental educatio","Extended Learning Opportunities", "Financial Literacy","Formative Assessment", "Health Education",
            # "Highly Mobile Students","Inquiry-based Learning", "LQBTQ+", "Mathmatics", "Multiple Learning Pathways", "Online Education", "Outdoor Education",
            # "Physical Education", "Programming", "Project based Learning", "Restorative Practices", "School Climate", "School Violence", "Science", "Service Learning",
            # "Social and Emotional Learning","Social Studies history", "Special Education", "STEM", "Student Engagement", "Suicide Prevention", "Teaching Strategies",
            "Technology Integration", "Trauma-informed Practices", "Extended Learning Opportunties"],
            maxtags=11,
        ...
        pre_defined_keyphrases = [
            "Upload a few paragraphs from the resource you're interested in tagging this is a longer phrase with the word education in it",
            "Limit uploads to a few paragraphs"
        ]
